...
This hash table is keyed by the type of a component instance.
The value is a list of thunks associated with those components which
are currently stored in the actors in actor-inititialize-db.
