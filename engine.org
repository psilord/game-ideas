...
which is conceptually stored in the game-object.
...
** Core State API
*** Function ADD-INITIALIZING-GAME-OBJECT
#+BEGIN_SRC common-lisp
(ADD-INITIALIZING-GAME-OBJECT core-state game-object
			      initializer-thunk-list)
#+END_SRC

This function takes a core-state, the game-object (filled with
